            ...
            <TabsContent value="schedule">
              <div className="flex items-center gap-4 mt-3 mb-7">
                <div className="w-1/3">
                  ...
                  <FormInput id="boat" placeholder="Select boat" />
                </div>
                <div className="w-1/3">
                  <FormLabel htmlFor="start_date">
                    Available start date
                  </FormLabel>
                  <FormInput id="start_date" placeholder="Select start date" />
                </div>
                <div className="w-1/3">
                  <FormLabel htmlFor="end_date">Available end date</FormLabel>
                  <FormInput id="end_date" placeholder="Select end date" />
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 mt-2">
                <div className="w-1/2">
                  ...
                  <FormInput id="start_time" placeholder="Select start time" />
                </div>
                <div className="w-1/2">
                  <FormLabel htmlFor="end_time">End time</FormLabel>
                  <FormInput id="end_time" placeholder="Select end time" />
                </div>
              </div>
